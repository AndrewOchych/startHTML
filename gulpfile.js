...
exports.assets      = gulp.series( cleanimg, cleanfonts, styles, scripts, images, fonts);
exports.default     = gulp.parallel(clean, html, styles, scripts, images, fonts, browsersync, startwatch);